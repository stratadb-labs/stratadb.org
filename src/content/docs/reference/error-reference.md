...
**When:** A feature is recognized but not yet available. Fork, diff, and merge are now implemented — see the [Branch Management Guide](/docs/guides/branch-management).
